<?php
	...
	if (isset($_POST['action']) && $_POST['action'] == 'disp_all_notes') {
	  ...
	  if ($notes) {
	    ...
	    echo '<h3 class="text-center text-secondary">Hello Teacher/Guest Teacher. Write your first report here.</h3>';
	  }
	}
	...
	if (isset($_POST['action']) && $_POST['action'] == 'fetchAllNotification') {
	  ...
	  if ($notification) {
	    ...
	    echo '<h3 class="text-center text-secondary mt-5">Not any new notifications yet.</h3>';
	  }
	}
