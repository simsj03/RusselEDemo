...
<body class="bg-info">
      ...
      <div class="col-lg-10 my-auto">
        <div class="card-group myShadow">
          <div class="card rounded-left p-4" style="flex-grow:1.4;">
            <h1 class="text-center font-weight-bold text-primary">Russell Elementary:    Sign in to Account</h1>
            <hr class="my-3">
  ...
  echo $_COOKIE['password'];
          ...
          <div class="card justify-content-center rounded-right myColor p-4">
            <h1 class="text-center font-weight-bold text-white">Hello Teachers and Guest Teachers</h1>
