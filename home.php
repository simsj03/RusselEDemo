...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      ...
      <?php endif; ?>
      <h4 class="text-center text-primary mt-2">Send your work report to admin.</h4>
    </div>
  </div>
  <div class="card">
    <h5 class="card-header bg-primary d-flex justify-content-between">
      <span class="text-light align-self-center lead">All Reports</span>
      <a href="#" data-toggle="modal" data-target="#addNoteModal" class="btn btn-light"><i class="fas fa-plus-circle fa-lg"></i>&nbsp;Send New Report</a>
    </h5>
    <div class="card-body">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-success">
        <h4 class="modal-title text-light">Send New Report</h4>
      ...
      <div class="modal-body">
        <form action="#" method="post" id="add-note-form" class="px-3">
          ...
          <div class="form-group">
            <textarea name="note" class="form-control form-control-lg" placeholder="Write Your Report Here..." rows="6" required></textarea>
          </div>
          <div class="form-group">
            <input type="submit" name="addNote" id="addNoteBtn" value="Send Report" class="btn btn-success btn-block btn-lg">
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="#" method="post" id="edit-note-form" class="px-3">
          ...
          <div class="form-group">
            <input type="submit" name="editNote" id="editNoteBtn" value="Update Report" class="btn btn-info btn-block btn-lg">
          </div>
        </form>
      </div>
    </div>
    ...
    if ($("#add-note-form")[0].checkValidity()) {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          Swal.fire({
            title: 'Report sent successfully to admin!',
            icon: 'success'
          });
          displayAllNotes();
        }
